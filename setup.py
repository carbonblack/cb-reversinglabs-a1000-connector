...
data_files.append('cb-reversinglabs-a1000-connector.spec')
data_files.append('scripts/cb-reversinglabs-a1000-connector')
scripts = {
    'cb-reversinglabs-a1000-connector': {
        'spec': 'cb-reversinglabs-a1000-connector.spec',
        'dest': '/usr/share/cb/integrations/reversinglabs-a1000/bin/'
    }
}

setup(
    name='python-cb-reversinglabs-a1000-connector',
    version='1.0',
    packages=['cbopensource', 'cbopensource.connectors', 'cbopensource.connectors.reversinglabsa1000'],
    url='https://github.com/carbonblack/cb-reversinglabs-a1000-connector',
    license='MIT',
